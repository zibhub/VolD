...
XSTREAM = transitive('com.thoughtworks.xstream:xstream:jar:1.4.1')
...
SPRING_SECURITY = [
    "org.springframework.security:spring-security-aspects:jar:#{SPRING_VERSION}",
    "org.springframework.security:spring-security-core:jar:#{SPRING_VERSION}",
